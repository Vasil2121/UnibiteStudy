...
if (isset($_FILES['photo']) && $_FILES['photo']['error'] !== UPLOAD_ERR_NO_FILE) {
    ...
    if ($photo['error'] !== UPLOAD_ERR_OK) {
        $fields['photo'] = 'Η μεταφόρτωση της φωτογραφίας απέτυχε.';
    } elseif ($photo['size'] > 5 * 1024 * 1024) {
        $fields['photo'] = 'Η φωτογραφία ξεπερνά τα 5 MB.';
    } else {
        ...
        if (!isset($allowedMimes[$mime])) {
            $fields['photo'] = 'Επιτρέπονται μόνο εικόνες JPG, PNG ή WEBP.';
        } else {
...
try {
    ...
    jsonResponse(['success' => false, 'error' => 'Could not create listing'], 500);
}
