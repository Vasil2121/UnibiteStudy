...
$allergens = [];
$result = $conn->query("SELECT id, name_el, icon FROM allergens ORDER BY id");
while ($row = $result->fetch_assoc()) {
    $allergens[] = $row;
}

$pageTitle = 'Δημιουργία Αγγελίας';
...
<div class="container cook-form">
    <div class="card">
        <h1 class="cook-form__title">Δημιουργία Αγγελίας</h1>
        <p class="cook-form__subtitle">Μοίρασε τις περισσευούμενες μερίδες σου με συμφοιτητές.</p>
        ...
        <form id="create-listing-form" novalidate>
            ...
            <div class="cook-form__group">
                <label class="form-label" for="photo">Φωτογραφία (προαιρετικά)</label>
                <input class="form-input" type="file" id="photo" name="photo"
                       accept="image/jpeg,image/png,image/webp">
                <img class="cook-form__photo-preview is-hidden" id="photo-preview" alt="Προεπισκόπηση φωτογραφίας">
            ...
            <div class="cook-form__group">
                ...
                <input class="form-input" type="text" id="pickup_location_text" name="pickup_location_text"
                       maxlength="255" required placeholder="π.χ. Κτίριο Β, Πανεπιστήμιο Πατρών">
            ...
            <div class="cook-form__group">
                <span class="form-label">Διάλεξε σημείο στον χάρτη *</span>
                <div id="map" class="cook-form__map"></div>
                <p class="cook-form__map-hint" id="map-hint">
                    Κάνε κλικ στον χάρτη για να ορίσεις το σημείο παραλαβής.
                </p>
            ...
            <div class="cook-form__group cook-form__group--row">
                <div>
                    ...
                    <input class="form-input" type="datetime-local" id="pickup_time_from"
                           name="pickup_time_from" required>
                ...
                <div>
                    ...
                    <input class="form-input" type="datetime-local" id="pickup_time_to"
                           name="pickup_time_to" required>
                    <span class="form-error" data-error-for="pickup_time_to"></span>
                </div>
            </div>

            <button type="submit" class="btn-primary" id="submit-btn">Δημοσίευση αγγελίας</button>
