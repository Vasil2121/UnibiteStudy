document.addEventListener('DOMContentLoaded', () => {
    ...
    const ENDPOINT = '/unibite/api/requests/incoming.php';
    const ACTION_ENDPOINTS = {
        approve: '/unibite/api/requests/approve.php',
        reject:  '/unibite/api/requests/reject.php',
        pickup:  '/unibite/api/requests/pickup.php',
        no_show: '/unibite/api/requests/no_show.php'
    };
